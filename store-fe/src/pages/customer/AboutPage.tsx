      ...
      <Grid container spacing={4} sx={{ mb: 6 }}>
        <Grid item xs={12} lg={6}>
          <Paper sx={{ p: 4, textAlign: "center", height: "100%" }}>
            ...
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              Founded with a passion for creating beautiful jewelry that tells a
              story, Saiyaara has been at the forefront of jewelry craftsmanship
              for over a decade. Our journey began with a simple dream: to make
              elegant, high-quality jewelry accessible to everyone.
            </Typography>
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              Today, we continue to blend traditional craftsmanship with modern
              design, creating pieces that are not just accessories, but
              expressions of individuality and style. Every piece in our
              collection is carefully crafted to ensure the highest quality and
              timeless beauty.
            </Typography>
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} lg={6}>
          <Paper sx={{ p: 4, textAlign: "center", height: "100%" }}>
            ...
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              At Saiyaara, our mission is to provide our customers with
              exceptional jewelry that combines contemporary design with
              traditional craftsmanship. We believe that every piece of jewelry
              should tell a story and create lasting memories.
            </Typography>
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              We are committed to:
            </Typography>
          ...
          <Paper sx={{ p: 4, textAlign: "center", height: "100%" }}>
            ...
            <Box sx={{ textAlign: "left" }}>
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body1" display="block">
                  We continuously innovate in design and craftsmanship to bring
                  you the best.
                </Typography>
              </Box>
              <Box>
        ...
        <Grid item xs={12} lg={6}>
          <Paper sx={{ p: 4, textAlign: "center", height: "100%" }}>
            ...
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              ...
              jewelry arrives at your doorstep.
            </Typography>
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              Our commitment extends beyond just selling jewelry - we want to be
              part of your special moments, helping you celebrate life&apos;s
              beautiful occasions with pieces that reflect your unique style and
              personality.
            </Typography>
            <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
              Thank you for choosing Saiyaara. We look forward to being part of

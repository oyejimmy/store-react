...
const AdminDashboard: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const categoryStatsData = targetCategories.map((categoryName) => {
        ...
        const dbCategory = safeCategories.find(
      ...
      setStats({
        ...
        totalCustomers: new Set(
          safeOrders.map((order: any) => order.customer_email).filter(Boolean)
        ).size,
        lowStockProducts: lowStock.length,
        pendingOrders: safeOrders.filter(
  ...
  //           <Typography
  //             variant="body2"
  //             sx={{ color: textColor, opacity: 0.9, mb: 1, fontWeight: 500 }}
  //           >
  //             {title}
  //           </Typography>
  //           <Typography
  //             variant="h4"
  //             sx={{ color: textColor, fontWeight: "bold", mb: 0.5 }}
  //           >
  //             {value}
  //           </Typography>
  //           {subtitle && (
  //             <Typography
  //               variant="caption"
  //               sx={{ color: textColor, opacity: 0.8 }}
  //             >
  //               {subtitle}
  //             </Typography>
  //           )}
    ...
    <Box sx={{ p: 0, minHeight: "100vh" }}>
        ...
        <Grid item xs={12} lg={6}>
          ...
          >
            <CardContent sx={{ p: 3 }}>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: "bold", color: "#e53e3e", mb: 2 }}
              >
                          ...
                          <Box sx={{ display: "flex", alignItems: "center" }}>
                            <Box sx={{ width: "100%", mr: 1 }}>
                              <LinearProgress
                                variant="determinate"
                                value={Math.min(
                                  (item.stock / (item.threshold || 10)) * 100,
                                  100
                                )}
                                color={
                                  item.stock === 0
        ...
        <Grid item xs={12} lg={6}>
          ...
          >
            <CardContent sx={{ p: 3 }}>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: "bold", color: "#3182ce", mb: 2 }}
              >
                {stats.pendingOrders}
              </Typography>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
      ...
      >
        <CardContent sx={{ p: 4 }}>
          ...
          <TableContainer>
            <Table
              sx={{ "& .MuiTableHead-root": { backgroundColor: "#f8fafc" } }}
            >
              <TableHead>
                <TableRow>
                  <TableCell
